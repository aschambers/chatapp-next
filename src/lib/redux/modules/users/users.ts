...
export const userUpdate = createAsyncThunk(
  'user/update',
  async (params: FormData | Record<string, unknown>) => {
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    // signup
    builder.addCase(userSignup.pending, (s) => {
      s.isLoading = true;
      s.error = false;
      s.success = false;
    });
    builder.addCase(userSignup.fulfilled, (s) => {
      s.isLoading = false;
      s.success = true;
    });
    builder.addCase(userSignup.rejected, (s) => {
      s.isLoading = false;
      s.error = true;
    });
    // login
    builder.addCase(userLogin.pending, (s) => {
      s.isLoading = true;
      s.error = false;
      s.notVerified = false;
    });
    builder.addCase(userLogin.fulfilled, (s, a) => {
      s.isLoading = false;
      s.user = a.payload;
    });
    ...
    // logout
    builder.addCase(userLogout.pending, (s) => {
      s.error = false;
    });
    builder.addCase(userLogout.fulfilled, (s) => {
      s.user = null;
    });
    builder.addCase(userLogout.rejected, (s) => {
      s.error = true;
    });
    // getUsers
    builder.addCase(getUsers.pending, (s) => {
      s.error = false;
    });
    builder.addCase(getUsers.fulfilled, (s, a) => {
      s.users = a.payload;
    });
    builder.addCase(getUsers.rejected, (s) => {
      s.error = true;
    });
    // getSingle
    builder.addCase(getSingleUser.pending, (s) => {
      s.error = false;
    });
    builder.addCase(getSingleUser.fulfilled, (s, a) => {
      s.user = a.payload;
    });
    builder.addCase(getSingleUser.rejected, (s) => {
      s.error = true;
    });
    // update
    builder.addCase(userUpdate.pending, (s) => {
      s.error = false;
    });
    builder.addCase(userUpdate.fulfilled, (s, a) => {
      s.user = a.payload;
    });
    builder.addCase(userUpdate.rejected, (s) => {
      s.error = true;
    });
    // delete
    ...
    builder.addCase(deleteUser.fulfilled, (s) => {
      s.user = null;
    });
    builder.addCase(deleteUser.rejected, (s) => {
      s.error = true;
    });
    // verify
    builder.addCase(userVerification.pending, (s) => {
      s.isLoading = true;
      s.error = false;
      s.success = false;
      s.already = false;
    ...
    builder.addCase(userVerification.rejected, (s) => {
      s.isLoading = false;
      s.error = true;
    });
    // sendEmail
    builder.addCase(sendEmail.fulfilled, (s) => {
      s.resultEmail = true;
    });
    builder.addCase(sendEmail.rejected, (s) => {
      s.noEmail = true;
    });
    // forgotPassword
    builder.addCase(forgotPassword.pending, (s) => {
      s.forgotPassSuccess = false;
      s.forgotPassError = false;
    });
    builder.addCase(forgotPassword.fulfilled, (s) => {
      s.forgotPassSuccess = true;
    });
    builder.addCase(forgotPassword.rejected, (s) => {
      s.forgotPassError = true;
    });
    // resetPassword
    builder.addCase(resetPassword.pending, (s) => {
      s.resetPassSuccess = false;
      s.resetPassError = false;
    });
    builder.addCase(resetPassword.fulfilled, (s) => {
      s.resetPassSuccess = true;
    });
    builder.addCase(resetPassword.rejected, (s) => {
      s.resetPassError = true;
    });
  },
});
