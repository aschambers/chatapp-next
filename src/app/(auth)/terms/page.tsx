    ...
    <div className="w-full max-w-2xl mx-auto py-10">
      <div className="rounded-lg bg-gray-800 p-8 shadow-lg text-gray-300 space-y-6 text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p>
            By creating an account or using Meshyve, you agree to these Terms of Service. If you do
        ...
        <section className="space-y-2">
          ...
          <p>
            You must be at least 13 years old to use Meshyve. By using the app you represent that
        ...
        <section className="space-y-2">
          ...
          <p>
            You retain ownership of content you post on Meshyve. By posting content, you grant us a
            limited license to store and display it as necessary to operate the service. You are
        ...
        <section className="space-y-2">
          ...
          <p>
            We may suspend or terminate your access to Meshyve at any time, with or without cause.
        ...
        <section className="space-y-2">
          ...
          <p>
            Meshyve is provided &quot;as is&quot; without warranties of any kind. We do not
            guarantee the service will be available at all times or free of errors.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            To the fullest extent permitted by law, Meshyve and its operators shall not be liable
        ...
        <section className="space-y-2">
          ...
          <p>
            We may update these terms at any time. Continued use of Meshyve after changes
